...
const Navbar = () => {
  ...
  return (
    <div className="w-full " style={{ backgroundColor: '#FFF5EB' }}>
      <nav className="flex items-center justify-between px-4 sm:px-6 md:px-16 lg:px-32 py-3 text-gray-700">
        <Image
      ...
      {/* Mobile Seller Dashboard Button - Separate Row */}
      {isSeller && (
        <div className="md:hidden px-4 sm:px-6 py-2 border-b border-gray-200">
          <button 
            onClick={() => router.push('/seller')} 
            className="w-full text-xs border border-gray-300 px-4 py-2 rounded-full text-center hover:bg-gray-100 transition-colors"
          >
            SELLER DASHBOARD
          </button>
        </div>
